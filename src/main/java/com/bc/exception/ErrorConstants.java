...
public class ErrorConstants {
    ...
    // VerifyPinCommand - Error codes and error message definitions.
    public static final String ERR_PINFNVR001 = "PINFNVR001";
    public static final String MSG_VER_PIN_CMD_PAN_NOT_NUM = "PAN must be numeric and 16 digits long.";
    public static final String ERR_PINFNVR002 = "PINFNVR002";
    public static final String MSG_VER_PIN_CMD_PVK_INVALID = "PIN Verification Key (PVK) must be comprised of 16, 32, 48 hexadecimal digits only.";
    public static final String ERR_PINFNVR003 = "PINFNVR003";
    public static final String MSG_VER_PIN_CMD_PIN_LEN_INVALID = "PIN Length must be numeric, and in the range 4 to 12.";
    public static final String ERR_PINFNVR004 = "PINFNVR004";

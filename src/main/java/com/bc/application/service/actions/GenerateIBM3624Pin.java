...
public class GenerateIBM3624Pin {
    ...
    public interface AddPinOffset {
         ...
         * @return PluggableRequest for User Exit.
         */
     ...
     */
    public static class Builder implements GetPinValidationData, TdeaEncryptPinValidationData, DecimaliseEncryptedValidationData, AddPinOffset, TruncateToPinLength, GenerateResponse {
         ...
         */
        @Override
        public Builder getPinValidationDataFromPan(String pan) {
         ...
         */
        @Override
        public Builder encryptPinValidationData(String pinVerificationKey) {
         ...
         */
        @Override
        public Builder decimaliseEncryptedValidationData(String decimalisationTable) {
         ...
         */
        @Override
        public Builder truncateToPinLength (String pinLength) {
         ...
         */
        @Override
        public Builder addPinOffset(String pinOffset) {
